...
> [!IMPORTANT]
> We strongly recommend reading the [Libtropic SDK documentation](https://tropicsquare.github.io/libtropic/latest/) to familiarize yourself with the basic concepts and then going through the First Steps as described in each guide in the following list, where you will be introduced to basic examples and will you update your chip's firmware.
