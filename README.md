...
[Tropic Square](https://www.tropicsquare.com) provides [TROPIC01](https://www.tropicsquare.com/tropic01) not only as a **silicon chip** but also as **various shields** and **devkits**, so the instructions differ.

> [!IMPORTANT]
> We strongly recommend reading the [Libtropic SDK documentation](https://tropicsquare.github.io/libtropic/latest/) to familiarize yourself with the basic concepts and then going through the tutorials, where you will be introduced to basic examples and you will update your chip's firmware.
 
Choose the tutorial based on the hardware you want to use:
